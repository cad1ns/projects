<?php include('header.php'); ?>
		<ul class="menu">
            ...
            <ul class="active">
                ...
                <li class="active"><a href="all_tweets.php">See all posts</li>
		...
		<?php
    		require_once 'db.php';
    $sql="SELECT tweets.text, tweets.date, user.name, user.surname FROM `tweets` INNER JOIN `user` ON tweets.user_id = user.user_id";
